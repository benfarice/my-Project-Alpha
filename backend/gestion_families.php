	...
	<div class="container-fluid text-right">			
			...
			<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12" id="div_get_families">
	  ...
	  <div class="modal-dialog modal-lg">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	      	...
	      	<div class="col-md-6 col-sm-6 col-xs-6">
	      		<button type="button" class="btn btn-danger btn-block" onclick="delete_confirm_family();">
	  ...
	  <div class="modal-dialog modal-lg">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	      	...
	      	<div class="col-md-6 col-sm-6 col-xs-6">
	      		<button type="button" class="btn btn-danger btn-block" onclick="update_confirm_family();">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        <div class="input-group input-group-lg">
			  ...
			  <input type="text" class="form-control" id="add_name_ar_family" aria-label="Large" aria-describedby="inputGroup-sizing-sm" placeholder="<?php //echo lang('new_espece_name_ar'); ?>">
			</div>
	      ...
	      <div class="modal-footer">
	      	...
	      	<div class="col-md-6 col-sm-6 col-xs-6">
	      		<button type="button" class="btn btn-primary btn-block" onclick="add_confirm_family();">
	        	<?php echo lang('ok'); ?>
	        	</button>
	      	</div>
	      </div>
